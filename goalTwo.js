...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    .then(responseData => {
        for (item of responseData) {
            ...
            const g5 = document.createElement("li");
            g5.textContent = item.goal5;
            listElement.appendChild(g5);
            g5.setAttribute("class", "info");
